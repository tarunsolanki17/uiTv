...
public class AboutFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ImageView mission_image= (ImageView)view.findViewById(R.id.mission_image);
        ImageView about_image=(ImageView)view.findViewById(R.id.about_image);
        ImageView contact = (ImageView)view.findViewById(R.id.contact);
        ImageView fbpage=(ImageView)view.findViewById(R.id.fbpage);
        ImageView webpage=(ImageView)view.findViewById(R.id.webpage);
        ...
        TextView e_mail = (TextView) view.findViewById(R.id.e_mail);
        final TextView fb_link = (TextView) view.findViewById(R.id.fblink);
        ...
        LinearLayout about_layout=(LinearLayout)view.findViewById(R.id.about_layout);
        LinearLayout contact_layout=(LinearLayout)view.findViewById(R.id.contact_layout);
        LinearLayout mail_layout=(LinearLayout)view.findViewById(R.id.mail_layout);
        LinearLayout webpage_layout = (LinearLayout)view.findViewById(R.id.webpage_layout);
