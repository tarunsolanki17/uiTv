...
import static com.example.tarun.uitsocieties.R.id.tarun_fb;
...
public class AboutTheDevelopers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_about_the_developers);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        TextView shubhi_email = (TextView)findViewById(R.id.shubhi_email);
        ...
        TextView tarun_email = (TextView)findViewById(R.id.tarun_email);
        ...
        TextView tarun_fb =(TextView)findViewById(R.id.tarun_fb);
        ...
        TextView shubhi_fb=(TextView)findViewById(R.id.shubhi_fb);
