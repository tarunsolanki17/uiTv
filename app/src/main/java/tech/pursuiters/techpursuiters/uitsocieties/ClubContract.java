...
//    public static final String DISHANJALI = "1406845922941085";
    ...
    public static final String[] CLUB_NAMES_VISIBLE = {"Aavahan","ACM-Student Chapter RGPV","Coherent","E-Cell","Green Army","HackerEarth","Insync","ISpeakAalay ","Mahasangram","Phoenix","शंखनाद","Srijan","Sundarban","Technophilic","TEDx RGPV"};
